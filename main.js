...
const CS={Admission:'bg-teal text-white',Event:'bg-amber-100 text-amber-700',Result:'bg-blue-100 text-blue-700',Holiday:'bg-gray-100 text-gray-500',Academics:'bg-purple-100 text-purple-700'};
const IC={
